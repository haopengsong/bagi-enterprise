...
`, // {{InputImage0}} {{ToolBrowser0}}
    ...
    examples: ['请简述SAP S/4HANA实施方法论', '请制作一份符合制造业行业最佳实践的QM模块培训大纲',' 在SAP S/4HANA中PM模块事务代码有哪些？','如何在SAP S/4HANA中配置销售绩效报表，以显示销售额、退货率和市场增长率？','在SAP S/4HANA中，如何配置物料库存状态报表，以优化库存水平并减少积压？','在SAP S/4HANA中如何查询物料主数据？','解释SAP S/4HANA的核心模块','如何在SAP S/4HANA环境中进行定制开发','ABAP编程最佳实践有哪些?','生产执行系统(MES)中的线边仓如何与SAP S/4线边仓对接？'],
    call: { starters: ['Dev here. Got code?', 'Developer on call. What\'s the issue?', 'Ready to code.', 'Hello.'] },
    voices: { elevenLabs: { voiceId: 'yoZ06aMxZJJ28mfd3POQ' } },
    // highlighted: true,
  },
