  ...
  listModels: publicProcedure
    ...
    .query(async ({ input }) => {
      ...
      const models = detailedModels
        .filter(model => model.displayName.toLocaleLowerCase().includes('1.5') && model.displayName.toLocaleLowerCase().includes('latest') && model.displayName.toLocaleLowerCase().includes('pro'))
